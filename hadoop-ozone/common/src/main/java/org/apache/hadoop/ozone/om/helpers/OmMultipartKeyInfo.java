...
public class OmMultipartKeyInfo extends WithObjectID {
  ...
  public static class Builder {
    ...
    public OmMultipartKeyInfo build() {
      return new OmMultipartKeyInfo(uploadID, creationTime, replicationType, replication, partKeyInfoList, objectID, updateID);
    }
  }
  ...
  public OmMultipartKeyInfo copyObject() {
    ...
    // immutable here.
    return new OmMultipartKeyInfo(uploadID, creationTime, replicationType, replication, new TreeMap<>(partKeyInfoList), objectID, updateID);
  }
